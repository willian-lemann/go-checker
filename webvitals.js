var webVitals = (function (t) {
  ...
  var e,
    ...
    y = function (t) {
      "hidden" === document.visibilityState &&
        g > -1 &&
        ((g = "visibilitychange" === t.type ? t.timeStamp : 0), S());
    },
    E = function () {
              ...
              t.forEach(function (t) {
                "first-contentful-paint" === t.name &&
                  ...
                  t.startTime < r.firstHiddenTime &&
                    ((i.value = Math.max(t.startTime - f(), 0)),
                    i.entries.push(t),
                    n(!0)));
              });
            });
          a &&
            ((n = m(t, i, L, e.reportAllChanges)),
            u(function (r) {
              ((i = d("FCP")),
                (n = m(t, i, L, e.reportAllChanges)),
                v(function () {
      ...
      if (
        ...
        if (n || A.length < 10 || t.duration > e.latency) {
          ...
          (A.sort(function (t, e) {
            ...
            A.length > 10 &&
              A.splice(10).forEach(function (t) {
          ...
          var r,
            ...
            a = function (t) {
              N(function () {
                ...
                e &&
                  e.latency !== i.value &&
                  ((i.value = e.latency), (i.entries = e.entries), r());
              });
            },
            o = l("event", a, {
              durationThreshold:
  ...
  j.push(
    function (t) {
      t.interactionId &&
        t.target &&
        !G.has(t.interactionId) &&
        G.set(t.interactionId, t.target);
    },
    function (t) {
      var e,
      ...
      for (var r = z.length - 1; r >= 0; r--) {
        ...
        if (Math.abs(n - i.renderTime) <= 8) {
          (((e = i).startTime = Math.min(t.startTime, e.startTime)),
      ...
      (e ||
        ...
        z.push(e)),
        (t.interactionId || "first-input" === t.entryType) && _.set(t, e),
        Q());
    },
  );
  var Y,
        ...
        "pointerdown" == t.type
          ? (function (t, e) {
              var n = function () {
                ...
                i = function () {
                  (removeEventListener("pointerup", n, ct),
                    removeEventListener("pointercancel", r, ct));
                };
              (addEventListener("pointerup", n, ct),
                addEventListener("pointercancel", r, ct));
            })(e, t)
          : ut(e, t);
      }
    },
        ...
        V(function (e) {
          var n = (function (t) {
            var e = t.entries[0],
              ...
              f = (u && u.target) || G.get(e.interactionId),
              d = [e.startTime + e.duration, a].concat(
                s.map(function (t) {
